    ...
    it('Fail, if account number is missing for updating account', (done) => {
     request(app).patch('/Account/update')
      ...
      .then((update1) => {
                ...
                expect(updated1.message)
          .to.equal('AccountNumber MISSING!!' )
        done();
      })
      .catch((err) => done(err));
    });
    ...
    it('Fail, if account number is wrong for updating account', (done) => {
     request(app).patch('/Account/update')
      ...
      .then((update2) => {
        ...
        expect(updated2.message)
          .to.equal('Account not found' )
        done();
      })
      .catch((err) => done(err));
    });
    ...
    it('Fail, if account number is missing to activate', (done) => {
     request(app).patch('/Account/activate')
      ...
      .then((res1) => {
        ...
        expect(body1.message)
          .to.equal('AccountNumber Is MISSING!!' )
        done();
      })
      .catch((err) => done(err));
    });
